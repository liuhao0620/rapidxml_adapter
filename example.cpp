...
int main()
{
  ...
  assert(doc2->first_node()->next_attribute(std::shared_ptr<xml_attribute<>>()) == doc2->first_node()->first_attribute());
  assert(doc2->first_node()->previous_attribute(std::shared_ptr<xml_attribute<>>()) == doc2->first_node()->last_attribute());
  assert(!doc2->first_node()->first_attribute("attr"));
  assert(doc2->first_node()->next_attribute(doc2->first_node()->first_attribute())->value() == "4");
  assert(doc2->first_node()->next_attribute(doc2->first_node()->first_attribute(), "attr1")->value() == "1");
  assert(!doc2->first_node()->next_attribute(doc2->first_node()->first_attribute(), "attr3"));
  assert(doc2->first_node()->last_attribute()->value() == "2");
  assert(!doc2->first_node()->last_attribute("attr"));
  assert(doc2->first_node()->previous_attribute(doc2->first_node()->last_attribute())->value() == "1");
  assert(doc2->first_node()->previous_attribute(doc2->first_node()->last_attribute(), "attr4")->value() == "4");
  assert(!doc2->first_node()->previous_attribute(doc2->first_node()->last_attribute(), "attr2"));
  ...
  assert(doc2->first_node()->next_node(std::shared_ptr<xml_node<>>()) == doc2->first_node()->first_node());
  assert(doc2->first_node()->previous_node(std::shared_ptr<xml_node<>>()) == doc2->first_node()->last_node());
  assert(doc2->first_node()->first_node()->name() == "roles");
  assert(doc2->first_node()->next_node(doc2->first_node()->first_node())->name() == "items");
  assert(doc2->first_node()->next_node(doc2->first_node()->first_node(), "items")->name() == "items");
  assert(!doc2->first_node()->next_node(doc2->first_node()->first_node(), "roles"));
  assert(doc2->first_node()->last_node()->name() == "items");
  assert(doc2->first_node()->previous_node(doc2->first_node()->last_node())->name() == "roles");
  assert(doc2->first_node()->previous_node(doc2->first_node()->last_node(), "roles")->name() == "roles");
  assert(!doc2->first_node()->previous_node(doc2->first_node()->last_node(), "items"));
  assert(!doc2->first_node()->first_node("none"));
  assert(!doc2->first_node()->last_node("none"));
